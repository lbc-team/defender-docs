...
https://blog.openzeppelin.com/doubling-down-on-open-source-and-phasing-out-defender[Read more, window=_blank]
====
...
- https://www.sei.io/[*Sei*, window=_blank] and *Sei Testnet (Atlantic-2)*.
