...
* *General*
- Bug fixes.
- Monitor UI improvement.

[[release-2025-05-07]]
== May 7th, 2025

* *General*
- Remove Forta related documentation.
- Minor bug fix.
...
* *General*
- Bug Fix: Issue with ABI retrieval on Sophon network.
- Bug Fix: Hide networks on wizard not available on deploy.
- Deprecate flaky rpc endpoints on Fantom network.
- Audit UI bug fixes.
...
- Minor bug fixes.
- Minor UI improvements.
- Fix deploy Block Explorer verification
